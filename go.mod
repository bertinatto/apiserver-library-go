...
replace github.com/openshift/client-go => github.com/bertinatto/client-go v0.0.0-20230623124427-bc27227b82fc

replace github.com/openshift/library-go => github.com/bertinatto/library-go v0.0.0-20230623125208-9fbc0120376c
