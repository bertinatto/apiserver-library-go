...
replace (
	github.com/openshift/api => github.com/bertinatto/api v0.0.0-20230721214632-69c8bd3171df
	github.com/openshift/client-go => github.com/bertinatto/client-go v0.0.0-20230721220335-8c54e232acb5
	github.com/openshift/library-go => github.com/bertinatto/library-go v0.0.0-20230721220950-45dd9e3b95da
)
